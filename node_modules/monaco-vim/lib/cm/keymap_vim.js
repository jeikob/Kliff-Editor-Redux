...
var Vim = function Vim() {
  function enterVimMode(cm) {
    ...
    _cm_adapter2.default.signal(cm, "vim-mode-change", { mode: "normal" });
  ...
  var actions = {
    ...
    toggleOverwrite: function toggleOverwrite(cm) {
      if (!cm.state.overwrite) {
        ...
        _cm_adapter2.default.signal(cm, "vim-mode-change", { mode: "replace" });
      } else {
        cm.toggleOverwrite(false);
        cm.setOption('keyMap', 'vim-insert');
        _cm_adapter2.default.signal(cm, "vim-mode-change", { mode: "insert" });
      }
    },
    ...
    toggleVisualMode: function toggleVisualMode(cm, actionArgs, vim) {
      ...
      if (!vim.visualMode) {
        ...
        _cm_adapter2.default.signal(cm, "vim-mode-change", { mode: "visual", subMode: vim.visualLine ? "linewise" : vim.visualBlock ? "blockwise" : "" });
        updateCmSelection(cm);
  ...
  */
  ...
  function handleExternalSelection(cm, vim) {
    ...
    if (vim.visualMode && !cm.somethingSelected()) {
      ...
      vim.visualMode = true;
      vim.visualLine = false;
      _cm_adapter2.default.signal(cm, "vim-mode-change", { mode: "visual" });
    }
    if (vim.visualMode) {
...
exports.Vim = Vim;
exports.default = _cm_adapter2.default;