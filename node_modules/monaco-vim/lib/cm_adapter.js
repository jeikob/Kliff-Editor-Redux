...
var CMAdapter = function () {
  ...
  _createClass(CMAdapter, [{
    ...
    value: function addCommands() {
      ...
      [_monacoEditor.KeyCode.Backspace, _monacoEditor.KeyCode.Delete, _monacoEditor.KeyMod.WinCtrl | _monacoEditor.KeyCode.KEY_D, _monacoEditor.KeyMod.WinCtrl | _monacoEditor.KeyCode.KEY_U, _monacoEditor.KeyMod.WinCtrl | _monacoEditor.KeyCode.KEY_N, _monacoEditor.KeyMod.CtrlCmd | _monacoEditor.KeyCode.KEY_A, _monacoEditor.KeyMod.CtrlCmd | _monacoEditor.KeyCode.KEY_D, _monacoEditor.KeyMod.CtrlCmd | _monacoEditor.KeyCode.KEY_P, _monacoEditor.KeyMod.CtrlCmd | _monacoEditor.KeyCode.KEY_O].forEach(function (key) {
        _this.commandList.push(_this.editor.addCommand(key, function () {}, '!insertMode'));
      });
    }
  }, {
    ...
    value: function getRange(start, end) {
      ...
      return this.editor.model.getValueInRange(_monacoEditor.Range.fromPositions(p1, p2));
    }
  }, {
    key: "getSelection",
    ...
    value: function setCursor(line, ch) {
      ...
      var monacoPos = this.editor.model.validatePosition(toMonacoPos(pos));
    ...
    value: function listSelections() {
      ...
      return selections.map(function (sel) {
        ...
        return {
          anchor: _this2.clipPos(toCmPos(_this2.getAnchorForSelection(sel))),
          head: _this2.clipPos(toCmPos(_this2.getHeadForSelection(sel)))
        };
      });
    }
  }, {
    ...
    value: function getSelections() {
      ...
      return editor.getSelections().map(function (sel) {
        return editor.model.getValueInRange(sel);
      });
    }
  }, {
    ...
    value: function clipPos(p) {
      var pos = this.editor.model.validatePosition(toMonacoPos(p));
      return toCmPos(pos);
    }
  }, {
    key: "setBookmark",
    ...
    value: function dispose() {
      ...
      this.commandList.forEach(function (commandId) {
        var _commandService = editor._commandService;
        var _dynamicKeybindings = editor._standaloneKeybindingService._dynamicKeybindings;

        var item = _dynamicKeybindings.find(function (binding) {
        ...
        var index = _dynamicKeybindings.indexOf(item);
    ...
    value: function enterVimMode() {
      ...
      var config = this.editor.getConfiguration();
    ...
    value: function markText() {
      ...
      return { clear: function clear() {}, find: function find() {} };
    }
  }, {
    ...
    value: function findPosV(startPos, amount, unit) {
      ...
      if (unit === 'page') {
        ...
        var lineHeight = editor.getConfiguration().fontInfo.lineHeight;
    ...
    value: function findMatchingBracket(pos) {
      ...
      var res = this.editor.model.matchBracket(mPos);
    ...
    value: function getSearchCursor(query, pos, caseFold) {
      ...
      var lastSearch = null;
      var matches = editor.model.findMatches(query, false, isRegex, matchCase) || [];
      var initialMatch = editor.model.findNextMatch(query, monacoPos, isRegex, matchCase);
      var currentIndex = matches.findIndex(function (m) {
        return initialMatch && m.range.equalsRange(initialMatch.range);
      }) - 1;
    ...
    value: function addOverlay(_ref, hasBoundary, style) {
      ...
      var match = this.editor.model.findNextMatch(query, this.editor.getPosition(), isRegex, matchCase);
    ...
    value: function removeOverlay() {
      ...
      ['currentFindMatch', 'findMatch'].forEach(function (key) {
        _this3.editor.deltaDecorations(_this3["decoration" + key] || [], []);
      });
    }
  }, {
    key: "scrollIntoView",
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleKeyDown = function (e) {
    ...
    if (_this4.replaceMode) {
      _this4.handleReplaceMode(key, e);
    }
    ...
    if (CMAdapter.keyMap.vim && CMAdapter.keyMap.vim.call) {
      var cmd = CMAdapter.keyMap.vim.call(key, _this4);
      if (cmd) {
        e.preventDefault();
        e.stopPropagation();
        cmd();
  ...
  this.handleCursorChange = function (e) {
    ...
    if (!_this4.ctxInsert.get() && e.source === 'mouse') {
      var maxCol = editor.model.getLineMaxColumn(position.lineNumber);
    ...
    _this4.dispatch('cursorActivity', _this4, e);
  };
  ...
  this.handleChange = function (e) {
    ...
    var curOp = _this4.curOp = _this4.curOp || {};

    if (!curOp.changeHandlers) {
      curOp.changeHandlers = _this4.listeners['change'] && _this4.listeners['change'].slice();
    }

    if (_this4.virtualSelectionMode()) {
      return;
    }
    ...
    _this4.dispatch('change', _this4, change);
    _this4.dispatch('cursorActivity', _this4, e);
  };
};
